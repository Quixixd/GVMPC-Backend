...
namespace Crimelife
{
    class FactionModule : Crimelife.Module.Module<FactionModule>
    {
        ...
        public static Vector3 StoragePosition = new Vector3(-1145.84, -3318.63, -16);
...
new NativeItem("1x FastEquipBC - 210000$", "FastEquipBC-210000-1")
        ...
        public static void initializeFraktionen()
        {
            ...
            try
            {
                ...
                NAPI.Marker.CreateMarker(1, new Vector3(-1272.57, -3378.89, -28.69), new Vector3(), new Vector3(), 1.0f, new Color(255, 140, 0));
                NAPI.Marker.CreateMarker(1, StoragePosition, new Vector3(), new Vector3(), 1.0f, new Color(255, 140, 0));*/

                ColShape val3 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-1143.39, -3321.41, -12.7), 1.4f, 1.4f, uint.MaxValue);
                ...
                ColShape val4 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-1140, -3316.85, -16), 1.4f, 1.4f, uint.MaxValue);
                ...
                ColShape val2 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-1272.84, -3377.9, -32.24), 1.4f, 1.4f, uint.MaxValue);
                ...
                ColShape val6 = NAPI.ColShape.CreateCylinderColShape(new Vector3(-1137, -3322.34, -12.7), 1.4f, 1.4f, uint.MaxValue);
                val6.SetData("FUNCTION_MODEL", new FunctionModel("openFrakbank"));
                val6.SetData("MESSAGE", new Message("Benutze E um die Fraktionsbank zu öffnen", "Fraktion", "green", 3000));
        ...
        public static void openFrak(Player c)
        {
            try
            {
                ...
                dbPlayer.ShowNativeMenu(new NativeMenu("Fraktionswaffenschrank", "Menu", new List<NativeItem>()
                {
                   ...
                   // new NativeItem("Fraktionsbank", "openfrakbank2")
            }));
            }
            catch (Exception ex) { }
        }
        ...
        public static void openFrakbank(Player c)
        {
            try
            {
                DbPlayer dbPlayer = c.GetPlayer();
...
new NativeItem("1x FastEquipBC - 210000$", "FastEquipBC-210000-1")
        ...
        [RemoteEvent("openfrakbank2")]
        public void openfrakbank2(Player c)
        {
            try
            {
                if (c == null) return;
            ...
            {
                Logger.Print("[EXCEPTION openFraktionsBank] " + ex.Message);
                Logger.Print("[EXCEPTION openFraktionsBank] " + ex.StackTrace);
            }
        }
